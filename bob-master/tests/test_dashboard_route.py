...
buckets, the accounts chart) -- template-only changes have no other test
coverage, and a bad Jinja expression only surfaces at render time.
"""
import json
...
from app.models import AuditRun, Flag, FlagCategory, RunStatus
...
def test_dashboard_renders_every_section_without_a_template_error(tmp_path):
    db_path = tmp_path / "dashboard_route.db"
